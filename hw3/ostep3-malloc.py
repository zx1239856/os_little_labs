...
parser.add_option('-p', '--policy',      default='BEST',     help='list search (BEST, WORST, FIRST, BUDDY)',
...
m = buddy_malloc(int(options.heapSize), int(options.baseAddr), int(options.headerSize), options.alignment) if options.policy == 'BUDDY' else malloc(int(options.heapSize), int(options.baseAddr), int(options.headerSize),
